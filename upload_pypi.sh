#!/usr/bin/env bash
# TransPaste - Build and upload to PyPI
set -e
cd "$(dirname "${BASH_SOURCE[0]}")"

PYTHON="${PYTHON:-python3}"
VERSION_FILE="src/transpaste/__init__.py"

echo "=== TransPaste PyPI Upload ==="
...
rm -rf dist/ build/ src/*.egg-info src/transpaste.egg-info
